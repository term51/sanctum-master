   ...
   export default {
      ...
      methods: {
         ...
         async getLocationTypesOfWorks() {
            ...
            await this.$http.get('wp/v2/auction/act-of-completed-work-location', {
               params: {
         ...
         async submitHandler() {
            ...
            try {
               ...
               // Отправка формы
               await this.$http.post('wp/v2/auction/act-of-completed-work-location', this.formData)
                  .then((response) => {
                     return response.json()
                  })
                  .then((response) => {
      ...
      mounted() {
         console.log('auction/Act-of-inspection-of-hidden-works-location.vue');
