   ...
   export default {
      ...
      methods: {
         ...
         async getAdditionalAgreementData() {
            ...
            await this.$http.get('wp/v2/document/additional-agreement', {
               params: {object_id: this.$route.params.id}
            })
               .then(response => {
         ...
         downloadDocument() {
            ...
            // window.open('http://imobile76.ru/wp-json/wp/v2/document/act-of-inspection-of-hidden-works');
            location.href = `${this.$http.options.root}/wp/v2/document/download-additional-agreement?object_id=${this.$route.params.id}`;
         },
         ...
         async submitHandler() { // Функция отправки формы
            ...
            try {
               ...
               await this.$http.post('wp/v2/document/additional-agreement', formData)
                  .then(response => {
                     //Получаем всё содержимое, все хедеры, статус и тд...
                     // console.log(response);
                     return response.json();
               ...
               console.log('catch Additional-agreement.vue');
               console.log(e);
            }
      ...
      mounted() {
         ...
         console.log('Additional-agreement.vue');
