      ...
      <section class="s-locations" v-else v-show="!loading">
         ...
         <table class="highlight">
            ...
            <tr
               ...
               :to="`/in-work/object-information/${$route.params.id}/accompanying-documentation-in-work/additional-documentation/act-of-inspection-of-hidden-works/`+location.id">
   ...
   export default {
      ...
      methods: {
         ...
         selectLocation(location) {
            ...
            this.$router.push(`/in-work/object-information/${this.$route.params.id}/accompanying-documentation-in-work/additional-documentation/act-of-inspection-of-hidden-works/` + location.id)
         },
         // скачивание акта скрытых работ
         async downloadAct() {
            this.$message('Скачивается акт скрытых работ');
            location.href = `${this.$http.options.root}/wp/v2/document/download-act-of-inspection-of-hidden-works?user_id=${this.$store.state.auth.userId}&object=${this.$route.params.id}`;
         }
      },
      mounted() {
         this.getLocations();
         console.log('act-of-inspection-of-hidden-works');
